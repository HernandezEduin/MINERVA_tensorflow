...
export PYTHONPATH="."
gpu_id=1
cmd="python code/model/nlq/evaluation.py --base_output_dir $base_output_dir --path_length $path_length --hidden_size $hidden_size --embedding_size $embedding_size \
    ...
    --eval_every $eval_every --print_path $print_path --use_beam $use_beam"
